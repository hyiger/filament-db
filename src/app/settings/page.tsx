...
export default function SettingsPage() {
  ...
  function currencyValidationMessage(err: ValidationError): string {
    switch (err) {
      case "code-empty":
        return t("settings.customCurrency.error.codeEmpty");
      case "code-too-short":
        return t("settings.customCurrency.error.codeTooShort");
      case "code-too-long":
        return t("settings.customCurrency.error.codeTooLong");
      case "code-invalid-chars":
        return t("settings.customCurrency.error.codeInvalidChars");
      case "code-collides-builtin":
        return t("settings.customCurrency.error.codeCollidesBuiltin");
      case "code-duplicate":
        return t("settings.customCurrency.error.codeDuplicate");
      case "symbol-empty":
        return t("settings.customCurrency.error.symbolEmpty");
      case "symbol-too-long":
        return t("settings.customCurrency.error.symbolTooLong");
    }
  }
          ...
          <div className="mt-4 p-4 rounded border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/50">
            ...
            {newCurrError && (
              <p className="mt-2 text-xs text-red-600 dark:text-red-400">
                {currencyValidationMessage(newCurrError)}
              </p>
            )}
